...
namespace IIS.Probadesyat
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadesyat.ЕдИзм fЕдиницыИзм;
        ...
        /// ЕдиницыИзм.
        /// </summary>
        // *** Start programmer edit section *** (Товары.ЕдиницыИзм CustomAttributes)

        // *** End programmer edit section *** (Товары.ЕдиницыИзм CustomAttributes)
        public virtual IIS.Probadesyat.ЕдИзм ЕдиницыИзм
        {
            get
            {
                // *** Start programmer edit section *** (Товары.ЕдиницыИзм Get start)

                // *** End programmer edit section *** (Товары.ЕдиницыИзм Get start)
                IIS.Probadesyat.ЕдИзм result = this.fЕдиницыИзм;
                // *** Start programmer edit section *** (Товары.ЕдиницыИзм Get end)

                // *** End programmer edit section *** (Товары.ЕдиницыИзм Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Товары.ЕдиницыИзм Set start)

                // *** End programmer edit section *** (Товары.ЕдиницыИзм Set start)
                this.fЕдиницыИзм = value;
                // *** Start programmer edit section *** (Товары.ЕдиницыИзм Set end)

                // *** End programmer edit section *** (Товары.ЕдиницыИзм Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Probadesyat.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Probadesyat.Товары));
                }
            }
        }
    }
