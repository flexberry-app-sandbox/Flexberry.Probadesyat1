...
namespace IIS.Probadesyat
{
    ...
    [View("ФормирРезПосE", new string[] {
            ...
            "ФормирРаспр.ДокумПоставки.Клиенты.НаимЗаказчика as \'Заказчик\'",
            "ФормирРаспр.ДокумПоставки.Клиенты.Телефон as \'Телефон\'",
            "ФормирРаспр.ДокумПоставки.Клиенты.АдресПоставки as \'Адрес поставки\'",
    ...
    public class ФормирРезПос : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadesyat.СостоянЗаказа fСтатусЗаказа;
        
        private bool fНаличДеф;
        
        private IIS.Probadesyat.УдовлКл fУдовлКлиента;
        
        private IIS.Probadesyat.ФормирРаспр fФормирРаспр;
        ...
        public virtual IIS.Probadesyat.СостоянЗаказа СтатусЗаказа
        {
            get
            {
                ...
                IIS.Probadesyat.СостоянЗаказа result = this.fСтатусЗаказа;
        ...
        public virtual IIS.Probadesyat.УдовлКл УдовлКлиента
        {
            get
            {
                ...
                IIS.Probadesyat.УдовлКл result = this.fУдовлКлиента;
        ...
        [PropertyStorage(new string[] {
                "ФормирРаспр"})]
        [NotNull()]
        public virtual IIS.Probadesyat.ФормирРаспр ФормирРаспр
        {
            get
            {
                ...
                IIS.Probadesyat.ФормирРаспр result = this.fФормирРаспр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосE", typeof(IIS.Probadesyat.ФормирРезПос));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосL", typeof(IIS.Probadesyat.ФормирРезПос));
                }
            }
        }
    }
